...
import {
  IProviderRentalOrders,
  IProviderSingleOrder,
  IRentalOrderData,
  IUserRentalOrders,
} from "@/lib/types";
...
export const ProviderRentalTable = async (
  rentalOrderList: IProviderRentalOrders,
) => {
  const orders: IProviderSingleOrder[] = rentalOrderList.data;
